...
import (
	...
	"github.com/zdq0394/consul-operator/pkg/apis/consul"
)

const (
	version      = "v1alpha1"
	RCKind       = "Consul"
	RCNamePlural = "consuls"
	RCScope      = apiextensionsv1beta1.NamespaceScoped
)

// SchemeGroupVersion is group version used to register these objects
var SchemeGroupVersion = schema.GroupVersion{Group: consul.GroupName, Version: version}
